...
export type Paradigm = 'html-css-gsap' | 'react-tsx' | 'ts-generator' | 'json-scene' | 'imperative-canvas';
...
export type TemplateCategory = 'data-viz' | 'social-shorts' | 'product-demo' | 'explainer' | 'marketing' | 'intro-outro' | 'ambient' | 'documentary' | 'presentation' | 'transition';
...
export interface TemplateMetadata {
    ...
    performance?: {
        reference_render: PerformanceRef;
    };
