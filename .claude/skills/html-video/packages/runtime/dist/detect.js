...
export async function resolveBin(def) {
...
async function probeVersion(bin, args) {
    try {
...
export async function detectOne(def) {
    ...
    if (def.extraDetect) {
        ...
        if (extra.version !== undefined && extra.version !== null)
