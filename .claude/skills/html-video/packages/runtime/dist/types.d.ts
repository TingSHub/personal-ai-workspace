...
export interface AgentDef {
     ...
     */
    extraDetect?: (resolvedBin: string) => Promise<{
        available: boolean;
        version?: string | null;
        hint?: string;
    }>;
     ...
     */
    httpHandler?: (prompt: string, ctx: AgentInvokeContext, onEvent: (e: import('./types.js').AgentEvent) => void, abortSignal: AbortSignal) => Promise<{
        exitCode: number;
    }>;
    /**
