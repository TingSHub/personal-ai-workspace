...
| files | `reference.wav`、`sample.mp3`、`emotion/`（含 `surprised.wav`） |
...
| verification | 基础参考音频已通过稳定播客 canary；`surprised.wav` 为豆包 expressive 生成；其余 emotion/ 由 podcast-audio-compiler 的复用脚本生成并逐条检查 |
