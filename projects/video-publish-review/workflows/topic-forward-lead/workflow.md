...
作为新视频的唯一选题入口：从重大事件、产业变化、公司实力与产品、观众问题、已有研究及可选行情信号中发现值得研究的问题，先按内容主线拆成互斥的观众任务，再生成至少 10 张轻量核验的 topic card，并取得一次真实用户批准。批准卡只决定“研究什么以及以哪条内容主线研究”，不预设研究结论或逐句视频结构。
