...
把已验收的事实研究包变成有明确判断、自然双人播客表达和增长承诺的锁定内容包。按 `content_depth` 组织短机制课或深度解释型节目：深度模式保留一条核心机制，但用历史、新闻和市场预期关系把它讲透。只做编辑判断与表达编排，不补研究、不执行音频或视觉制作。
...
从冻结研究包中选择唯一核心主张、叙事模式、开场、知识路径、模块顺序、增长承诺和结尾条件；深度模式要把历史与市场关系安排成证明链，而不是资料附录。
