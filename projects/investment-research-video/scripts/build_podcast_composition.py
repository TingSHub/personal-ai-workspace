#!/usr/bin/env python3
"""Build a subject-agnostic HyperFrames podcast composition from episode.json and segments.json."""
...
</style></head><body><main class="cover"><div class="ledger"></div><div class="side left">产业<br>技术<br>事件<br>公司<br>—</div><div class="side right">证据<br>机制<br>争议<br>判断<br>—</div><div class="brand"><img class="cover-brand-mark" src="assets/__MARK_FILE__" alt=""><div class="brand-wordmark">账本两面</div></div><div class="brand-tag">看懂变化背后的逻辑</div><div class="rule"></div><div class="subject">__SUBJECT__</div><h1 class="title">__TITLE__</h1><div class="subline">__SUBTITLE__</div><div class="desk"><div class="paper-back"></div><div class="paper-front"></div><div class="pen"></div></div></main></body></html>'''
...
def main():
    ...
    subject_label = episode.get('subject_name') or episode.get('company') or episode.get('company_name') or '财经研究'
    ...
    cover_subtitle = episode.get('cover_subtitle') or cover_spec.get('subtitle') or f"{subject_label} 深度解析"
    cover_subject = cover_spec.get('subject_label') or subject_label
