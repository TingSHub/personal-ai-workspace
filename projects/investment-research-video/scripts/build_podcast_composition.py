...
def main():
    ...
    cover_doc=f'''<!doctype html><html lang="zh-CN"><head><meta charset="UTF-8"><meta name="viewport" content="width=1920,height=1080"><style>{font_css}html,body{{margin:0;width:1920px;height:1080px;background:#faf7f1;color:#211d18}}.cover{{box-sizing:border-box;width:1920px;height:1080px;padding:86px 112px;display:flex;flex-direction:column;justify-content:center;border-top:12px solid #a6192e}}.brand{{display:flex;align-items:center;gap:22px;color:#a6192e;font:700 28px NotoSerifSC,serif;letter-spacing:.08em}}.brand img{{width:72px;height:72px;object-fit:contain}}h1{{max-width:1550px;margin:78px 0 28px;font:900 92px/1.18 NotoSerifSC,serif;letter-spacing:.02em}}p{{max-width:1450px;margin:0;color:#6a6354;font:400 34px/1.5 NotoSerifSC,serif}}.rule{{width:240px;height:5px;background:#a6192e;margin-top:72px}}</style></head><body><main class="cover"><div class="brand">{logo_tag}{html.escape(company_label)}</div><h1>{html.escape(cover_title)}</h1><p>{html.escape(cover_subtitle)}</p><div class="rule"></div></main></body></html>'''
